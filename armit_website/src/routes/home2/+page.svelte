<div class="flex flex-col h-auto w-full max-w-full max-h-full">
    <div class="flex w-full h-screen relative overflow-hidden">
        <div class="flex flex-col w-full h-screen bg-no-repeat bg-cover lg:bg-header bg-header-mobile absolute overflow-hidden">
            ...
            <header class="flex h-full font-inter text-white">
                <div class="flex flex-col h-full lg:items-start items-center justify-center">
                    <div class="flex flex-grow justify-end flex-col gap-4 w-full md:w-2/3 2xl:w-1/2 lg:pl-40">
                        <div class="flex 2xl:text-7xl text-5xl lg:text-start text-center">
                            Chalmers' IT Corporate Relations Committee
                        </div>
                        <div class="flex md:text-4xl text-3xl lg:text-start text-center">
                    ...
                    <div class="flex flex-col flex-grow justify-center lg:justify-end gap-2 lg:text-start text-center lg:pl-40 mb-4 w-full lg:px-0 px-4 text-navtext overflow-hidden 2xl:text-2xl lg:text-xl">
                        Trusted by 
                        <div class="flex items-center lg:justify-start justify-center w-full gap-12">
                            ...
                            <img class="h-auto w-1/3 md:w-1/6 max-h-full" alt="Accenture" src="/Accenture_logo.png"/>
                        </div>
                    </div> 
                </div>
            </header>
        </div>
        <div class="lg:hidden flex flex-col w-full h-screen bg-white overflow-hidden absolute translate-x-full">
            <nav class="flex w-full h-32 text-white">
                <div class="flex w-full justify-end p-12 items-center">
                    <button>
                        <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="#1a2d45" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" class="feather feather-x"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>
                    </button>
                </div>
            </nav>
            <header class="flex h-full font-inter text-navtext">
                <div class="flex flex-col items-center justify-center">
                    <div class="flex flex-grow justify-end flex-col gap-8 w-full pl-10">
                        <a href="#" class="flex text-4xl">
                            Contact us
                        </a>
                        <a href="https://www.date-it.se" class="flex text-4xl">
                            DatE-IT
                        </a>
                    </div>
